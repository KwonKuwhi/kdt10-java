...
//        System.out.println(temp[0]); // NullPointerEvception
...
/////////////////////////////////////
        ...
        // - Object src: 원본 배열
        // - int srcPst: 원본 배열 복사 시작 인덱스
        // - Object dest : 새 배열
        // - int destPost : 새배열 붙여넣기 시작 할 인덱스
        // - int length: 복사 항목 수
        ...
        System.out.println("copied Array : " + Arrays.toString(rangeArray));
        ...
        boolean arraysEquls2 = Arrays.equals(array1,array3);

        System.out.println("arrays equal (1 vs 2) : " + arraysEqual); // true
        System.out.println("arrays equal (1 vs 3) : " + arraysEquls2); // false
        ...
        boolean deepArraysEqual3 = Arrays.deepEquals(deepArray1, deepArray2);
        boolean deepArraysEqual4 = Arrays.deepEquals(deepArray1, deepArray3);

        System.out.println("deep arrays equal (1 vs 2) : " + deepArraysEqual3); // true
        System.out.println("deep arrays equal (1 vs 3) : " + deepArraysEqual4); // false

...
public class ExceptionEx {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 예외 출력 방법
            // 방법 1: 예외 발생한 이유만 보여줌
            System.out.println("나누리 중 에러 발생 >> " + e.getMessage());

            // 방법 2: 예외 종류 리턴
            System.out.println("나누리 중 에러 발생 >> " + e.toString());
...
//        System.out.println(getValueByIdx(numbers, numbers.length)); //ArrayIndexOutOfBoundsException
        ...
        // case 3. 예외 처리 코드
          try{
              ...
              System.out.println("배열 인덱싱 중 에러 발생>> " + e.getMessage()); // Index 5 out of bounds for length 5
          }
